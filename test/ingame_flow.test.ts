...
import * as ingame from "../src/engine/ingame";
import * as widgets from "../src/engine/widgets";
import * as movement from "../src/engine/movement";
import * as C from "../src/engine/constants";
import * as weapons from "../src/engine/weapons";
import type { GameState, Tank, Cfg, IngameEvent, MouseState, InfoBox } from "../src/engine/ingame";
