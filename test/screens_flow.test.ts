...
import * as screens from "../src/engine/screens";
import * as joystick from "../src/engine/joystick";
import * as weapons from "../src/engine/weapons";
import * as W from "../src/engine/widgets";
import * as pygame from "../src/engine/pygame";
import * as savegame from "../src/engine/savegame";
import { Economy } from "../src/engine/economy";
import type { EconomyConfig, EconomyTank } from "../src/engine/economy";
import { Config } from "../src/engine/config";
import type { ScreenEvent } from "../src/engine/screen";
