...
import * as wb from "../src/engine/weapon_behaviors";
import type { BState, BTank, BTerrain, BProjectile } from "../src/engine/weapon_behaviors";
import * as damage from "../src/engine/damage";
import { Rng } from "../src/engine/rng";
import * as C from "../src/engine/constants";
import { ITEMS, Item } from "../src/engine/weapons";
